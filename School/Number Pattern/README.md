<h2><a href="https://practice.geeksforgeeks.org/problems/number-pattern0517/1?page=2&difficulty[]=-2&sortBy=accuracy">Number Pattern</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">For a given number <strong>N</strong>. Print the pattern in the following form: 1 121 12321 1234321 for N = 4.</span></p>
