<h2><a href="https://practice.geeksforgeeks.org/problems/magical-string3653/1?page=1&difficulty[]=-1&category[]=Strings&sortBy=submissions">Magical String[Duplicate Problem]</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given a string S, convert it into a magical string.<br>
